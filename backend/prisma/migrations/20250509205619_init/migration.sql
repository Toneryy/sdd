...
-- AddForeignKey
ALTER TABLE "promo_usage" ADD CONSTRAINT "promo_usage_promocode_id_fkey" FOREIGN KEY ("promocode_id") REFERENCES "promocodes"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
